...
#ifndef MONISM_POPL_HH
#define MONISM_POPL_HH
...
/// option_parser manages all Options
/**
 * option_parser manages all Options
 ...
 */
    ...
    {
    public:
        /// Construct the option_parser
        /// @param description used for the help message
        explicit option_parser(std::string description = "");

        /// Destructor
        virtual ~option_parser() = default;
        ...
        /// Get the option_parser's description
...
/**
 * OptionPrinter creates a help message for a given option_parser
 */
    class OptionPrinter
    {
    public:
        /// Constructor
        /// @param option_parser the option_parser to create the help message from
        explicit OptionPrinter(const option_parser* option_parser) : option_parser_(option_parser)
        {
        }
    ...
    protected:
        const option_parser* option_parser_;
    };
 ...
 */
    ...
    {
    public:
        explicit ConsoleOptionPrinter(const option_parser* option_parser);
 ...
 */
    ...
    {
    public:
        explicit GroffOptionPrinter(const option_parser* option_parser);
 ...
 */
    ...
    {
    public:
        BashCompletionOptionPrinter(const option_parser* option_parser, std::string program_name);
...
/// value implementation /////////////////////////////////
    ...
    template <class T>
    inline T value<T>::get_value(size_t idx) const
    {
...
/// Implicit implementation /////////////////////////////////
    ...
    template <class T>
    inline void Implicit<T>::parse(OptionName what_name, const char* values)
    {
        if ((values != nullptr) && (strlen(values) > 0))
            value<T>::parse(what_name, values);
        else
...
/// option_parser implementation /////////////////////////////////

    inline option_parser::option_parser(std::string description) : description_(std::move(description))
    {
    }


    template <typename T, typename... Ts>
    inline std::shared_ptr<T> option_parser::add(Ts&&... params)
    {
    ...
    inline std::string option_parser::description() const
    {
        return description_;
    }


    inline const std::vector<Option_ptr>& option_parser::options() const
    {
        return options_;
    }


    inline const std::vector<std::string>& option_parser::non_option_args() const
    {
        return non_option_args_;
    }


    inline const std::vector<std::string>& option_parser::unknown_options() const
    {
        return unknown_options_;
    }


    inline Option_ptr option_parser::find_option(const std::string& long_name) const
    {
    ...
    inline Option_ptr option_parser::find_option(char short_name) const
    {
        for (const auto& option : options_)
    ...
    template <typename T>
    inline std::shared_ptr<T> option_parser::get_option(const std::string& long_name) const
    {
    ...
    template <typename T>
    inline std::shared_ptr<T> option_parser::get_option(char short_name) const
    {
    ...
    inline void option_parser::parse(const std::string& ini_filename)
    {
    ...
    inline void option_parser::parse(int argc, const char* const argv[])
    {
    ...
    inline void option_parser::reset()
    {
    ...
    inline std::string option_parser::help(const Attribute& max_attribute) const
    {
...
/// ConsoleOptionPrinter implementation /////////////////////////////////
    ...
    inline ConsoleOptionPrinter::ConsoleOptionPrinter(const option_parser* option_parser) : OptionPrinter(option_parser)
    {
    }
...
/// GroffOptionPrinter implementation /////////////////////////////////
    ...
    inline GroffOptionPrinter::GroffOptionPrinter(const option_parser* option_parser) : OptionPrinter(option_parser)
    {
    }
...
/// BashCompletionOptionPrinter implementation /////////////////////////////////
    ...
    inline BashCompletionOptionPrinter::BashCompletionOptionPrinter(const option_parser* option_parser, std::string program_name)
...
complete -F )";
    ...
    static inline std::ostream& operator<<(std::ostream& out, const option_parser& op)
    {
        return out << op.help();
    }
